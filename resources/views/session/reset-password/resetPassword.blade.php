                    ...
                    <div class="card shadow-sm" style="border-radius: 15px;">
                        <div class="card-body p-3">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h3 class="font-weight-bold m-0" style="font-size: 1.25rem;">Reset Password</h3>
                            ...
                            <form action="{{ route('password.update') }}" method="POST" role="form">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="email" name="email" type="email" class="form-control form-control-sm" 
                                           placeholder="Enter your email" style="background-color: #f1f1f1; border-radius: 8px;" value="{{ request()->email }}">
                                    @error('email')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="password" name="password" type="password" class="form-control form-control-sm" 
                                           placeholder="Enter new password" style="background-color: #f1f1f1; border-radius: 8px;">
                                    @error('password')
                                        <p class="text-danger text-xs mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input id="password_confirmation" name="password_confirmation" type="password" class="form-control form-control-sm" 
                                           placeholder="Confirm new password" style="background-color: #f1f1f1; border-radius: 8px;">
                                </div>
