    ...
    <div class="container-fluid py-2 px-4">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4 d-flex justify-content-end" id="navbar"> 
            ...
            <li class="nav-item px-3 d-flex align-items-center">
                <a href="{{ route('messages.index') }}" class="nav-link text-body p-0 icon-link position-relative">
                    <i class="fa fa-comments cursor-pointer fs-5"></i>
                    <span id="unread-message-count" class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger" style="font-size: 0.5rem; display: none;"></span>
                </a>
            </li>
...
// Check for unread messages when page loads
